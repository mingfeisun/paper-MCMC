...
Such distribution matching idea, as attempted by many recent studies, can also be used to unify different imitation learning methods into one formulation by selecting divergence measures as the statistical distance.
